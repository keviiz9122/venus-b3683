...
public class Cuboid {
   ...
   public boolean rayTraceInternal(Supplier<String> var1, Predicate<MutableBlockLocation> var2) {
      double var3 = MathUtil.hypot(this.x2 - this.x1, this.y2 - this.y1, this.z2 - this.z1);
      double var5 = (this.x2 - this.x1) / var3;
      double var7 = (this.y2 - this.y1) / var3;
      double var9 = (this.z2 - this.z1) / var3;
      double var11 = MathUtil.lowest(var5, var7, var9);
   ...
   public Cuboid face(Direction var1) {
      switch(Direction.values()[var1.ordinal()]) {
      case 1:
         this.y1 = this.y2;
         break;
      case 2:
   ...
   public Cuboid hitbox() {
      return this.add(-0.3D, 0.3D, 0.0D, 1.8D, -0.3D, 0.3D).expand(0.1D, 0.1D, 0.1D);
   }
   ...
   public double distanceSquared(ILocation var1) {
      return this.contains(var1) ? 0.0D : Math.min(Math.pow(var1.getX() - this.x1, 2.0D), Math.pow(var1.getX() - this.x2, 2.0D)) + Math.min(Math.pow(var1.getY() - this.y1, 2.0D), Math.pow(var1.getY() - this.y2, 2.0D)) + Math.min(Math.pow(var1.getZ() - this.z1, 2.0D), Math.pow(var1.getZ() - this.z2, 2.0D));
   }
   ...
   public double distanceXZ(double var1, double var3) {
      if (this.containsXZ(var1, var3)) {
         ...
         double var5 = Math.min(Math.pow(var1 - this.x1, 2.0D), Math.pow(var1 - this.x2, 2.0D));
         double var7 = Math.min(Math.pow(var3 - this.z1, 2.0D), Math.pow(var3 - this.z2, 2.0D));
