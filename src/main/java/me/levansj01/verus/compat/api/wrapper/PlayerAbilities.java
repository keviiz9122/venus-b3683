...
public class PlayerAbilities {
   ...
   public int hashCode() {
      boolean var1 = true;
      byte var2 = 1;
      int var3 = var2 * 59 + (this.isDisableDamage() ? 79 : 97);
      var3 = var3 * 59 + (this.isFlying() ? 79 : 97);
      var3 = var3 * 59 + (this.isAllowFlying() ? 79 : 97);
      var3 = var3 * 59 + (this.isCreativeMode() ? 79 : 97);
      var3 = var3 * 59 + (this.isAllowEdit() ? 79 : 97);
      var3 = var3 * 59 + Float.floatToIntBits(this.getFlySpeed());
      var3 = var3 * 59 + Float.floatToIntBits(this.getWalkSpeed());
      return var3;
   }
